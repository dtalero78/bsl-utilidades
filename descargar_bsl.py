...
EMPRESAS_SIN_SOPORTE = [
    ...
    "TRANSRUBIO", "LOMI", "TEQUENDAMA", "G2", "GLOBAL GREEN", "GGA", "AGILISSA", "PROYTEC", "BOMBATEX",
    "ZARA", "ELITE", "CASA LASER", "GLOBO", "RANGEL", "INGEALIMENTOS", "JARDINEROS", "TRUSTEM",
    "ASPENVIEW COLOMBIA S.A.S.", "INCOBRA", "BIENESTAR PRIMERO BIP S.A.S", "CAMPO REAL"
]
